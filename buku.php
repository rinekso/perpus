...
$of=$batas*($p-1);
$r=mysql_query("select *from buku order by id desc limit $of,$batas");
...
<center>
<?php
$y=mysql_query("select *from buku");
$je=mysql_num_rows($y);
$jum=ceil($je/$batas);
for($u=1;$u<=$jum;$u++){
	if($u==$p){
...
?>
<a href=".?hal=buku&p=<?php echo $u;?>" class="<?php echo $cl;?>"><?php echo $u;?></a>
<?php }?>
</center>
<?php }?>
</div>
